      ...
      <Fragment>
        ...
        >
          ...
          >
            ...
            >
              <h2>A`A Roots Terms of Service</h2>
            </CardTitle>
          </Row>
                ...
                <CardBody>
                  ...
                  <ol type="a">
                    <li>
                      ...
                      the materials (information or software) on A`A Roots's
                      ...
                      <ol type="i">
                        ...
                        <li>
                          ...
                          contained on A`A Roots's website;
                        </li>
                        <li>
                    ...
                    <li>
                      ...
                      any of these restrictions and may be terminated by Aa
                      Roots at any time. Upon terminating your viewing of these
                      materials or upon the termination of this license, you
                  ...
                  <ol type="a">
                    <li>
                      The materials on A`A Roots's website are provided on an 'as
                      is' basis. A`A Roots makes no warranties, expressed or
                    ...
                    <li>
                      Further, A`A Roots does not warrant or make any
                  ...
                  <h3>4. Limitations</h3>
                  <p>
                    In no event shall A`A Roots or its suppliers be liable for
                    any damages (including, without limitation, damages for loss
                    of data or profit, or due to business interruption) arising
                    out of the use or inability to use the materials on Aa
                    Roots's website, even if A`A Roots or a A`A Roots authorized
                  ...
                  <p>
                    The materials appearing on A`A Roots's website could include
                    technical, typographical, or photographic errors. A`A Roots
                    does not warrant that any of the materials on its website
                    are accurate, complete or current. A`A Roots may make changes
                    to the materials contained on its website at any time
                    without notice. However A`A Roots does not make any
                    commitment to update the materials.
                  </p>
                  <h3>6. Links</h3>
                  <p>
                    A`A Roots has not reviewed all of the sites linked to its
                    website and is not responsible for the contents of any such
                    linked site. The inclusion of any link does not imply
                    endorsement by A`A Roots of the site. Use of any such linked
                    website is at the user's own risk.
                  </p>
                  <h3>7. Modifications</h3>
                  <p>
                    A`A Roots may revise these terms of service for its website
