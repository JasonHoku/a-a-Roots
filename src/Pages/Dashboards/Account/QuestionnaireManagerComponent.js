...
function QuestionaireManagerComponent() {
                  ...
                  <Row>
                    <Col>
                      ...
                      <Input
                        ...
                        value={loadedFlowData}
                        onChange={(e) => setloadedFlowData(e.target.value)}
                      ></Input>
                    </Col>
                    <Col>
                      <div style={{ textAlign: "left" }}>
                      ...
                      <Input
                        ...
                        value={loadedQuestionData}
                        onChange={(e) => setloadedQuestionData(e.target.value)}
                      ></Input>
                    </Col>
                  </Row>
                  <Row>
                    ...
                    >
                        ...
                        <Row>
                          <Col style={{ paddingRight: "0px" }}>
                            <div style={{ border: "1px solid" }}>
                              ...
                              Score&nbsp;
                              <Input
                                placeholder={readyYesScoreData}
                                style={{ width: "35px" }}
                              ></Input>
                              Flow
                              <Input
                                placeholder={readyYesFlowData}
                                style={{ width: "35px" }}
                              ></Input>
                              <br />
                              <div style={{ textAlign: "left" }}>
                              ...
                              Score&nbsp;
                              <Input
                                placeholder={readyNoScoreData}
                                style={{ width: "35px" }}
                              ></Input>
                              Flow
                              <Input
                                placeholder={readyNoFlowData}
                                style={{ width: "35px" }}
                              ></Input>
                              <br />
                              <div style={{ textAlign: "left" }}>
                              ...
                              Score&nbsp;
                              <Input
                                placeholder={readyNAScoreData}
                                style={{ width: "35px" }}
                              ></Input>
                              Flow
                              <Input
                                placeholder={readyNAFlowData}
                                style={{ width: "35px" }}
                              ></Input>
                            </div>
                          </Col>
                          <Col style={{ paddingLeft: "0px" }}>
                            <div style={{ border: "1px solid" }}>
                              ...
                              ></Input>{" "}
                              <br />
                              <b>Total CheckBoxes:</b> {readyCheckBoxCounter}
                              <br />
                            </div>
                          </Col>
                        </Row>
                      ...
                      <Input
                        ...
                        value={loadedAnswerData}
                        onChange={(e) => setloadedAnswerData(e.target.value)}
                      ></Input>
                    </Col>
                  </Row>
                </div>
            ...
            >
              ...
              >
                <h4 style={{ width: "100%", textAlign: "left" }}>
                  ...
                  <br />
                  Your Answers: <br />
                  {docError && <strong>Error: {JSON.stringify(error)}</strong>}
                  {docLoading && <span>Document: Loading...</span>}
                  {docValue && (
                    <span>
                      <FormControl className={classes.formControl}>
                ...
                <b>
                  <strong>
                    ...
                    Score {decideCurrentScore()} of{" "}
                    {readyQuestionScorePossibleTotal}, &nbsp;LeadsTo:{" "}
                    {readyNextQuestionFlow}
                    <br />
                  </strong>
                  &nbsp;
                </b>
...
export default QuestionaireManagerComponent;
