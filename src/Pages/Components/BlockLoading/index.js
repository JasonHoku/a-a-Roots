    ...
    return (
      <Fragment>
        <PageTitle heading="Block Loading"
          ...
          icon="fa fa-door-lock icon-gradient bg-night-fade"/>
                  ...
                  <CardHeader>
                    ...
                    <div className="btn-actions-pane-right">
                      <Button className="btn-icon btn-icon-only" color="link">
                        <i className="fa fa-leaf btn-icon-wrapper" />
                      </Button>
                      <Button className="btn-icon btn-icon-only" color="link">
                        <i className="fa fa-cloud-download btn-icon-wrapper" />
                      </Button>
                      <UncontrolledButtonDropdown>
                        <DropdownToggle className="btn-icon btn-icon-only" color="link">
                          <i className="fa fa-menu btn-icon-wrapper" />
                        </DropdownToggle>
