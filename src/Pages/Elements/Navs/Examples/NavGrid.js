                      ...
                      <Col md="3">
                        ...
                        <Nav vertical>
                          <Nav vertical>
                            ...
                            <NavItem>
                              <NavLink href="#">
                                <i className="nav-link-icon fa fa-chat"> </i>
                                <span>Chat</span>
                                <div className="ml-auto badge badge-pill badge-info">
                                  8
                                </div>
                            ...
                            <NavItem>
                              <NavLink href="#">
                                <i className="nav-link-icon fa fa-config"> </i>
                                <span>Settings</span>
                                <div className="ml-auto badge badge-success">
                                  New
                                </div>
                            ...
                            <NavItem>
                              <NavLink href="#">
                                <i className="nav-link-icon fa fa-coffee"> </i>
                                <span>Messages</span>
                                <div className="ml-auto badge badge-warning">
                                  512
                                </div>
                        ...
                        <DropdownMenu className="dropdown-menu-lg">
                          ...
                          <Nav vertical>
                            <Nav vertical>
                              ...
                              <NavItem>
                                <NavLink href="#">
                                  <i className="nav-link-icon fa fa-wallet"> {" "} </i>
                              ...
                              <NavItem>
                                <NavLink href="#">
                                  <i className="nav-link-icon fa fa-box2"> </i>
                                  <span>Logs</span>
                                </NavLink>
                              </NavItem>
                              <NavItem className="nav-item-divider" />
                        ...
                        <DropdownMenu className="dropdown-menu-lg">
                          ...
                          <Nav vertical>
                            <Nav vertical>
                              ...
                              <NavItem>
                                <NavLink href="#">
                                  <i className="nav-link-icon fa fa-wallet">
                                    {" "}
                                  </i>
                                  <span>Recover Password</span>
                                </NavLink>
                            ...
                            <div className="menu-header-content">
                              ...
                              <div className="menu-header-btn-pane">
                                ...
                                <Button size="sm" className="btn-icon btn-icon-only" color="primary">
                                  <i className="fa fa-config btn-icon-wrapper">
                                    {" "}
                                  </i>
                                </Button>
                              </div>
                            ...
                            <div className="menu-header-content text-left">
                              ...
                              <div className="menu-header-btn-pane">
                                ...
                                <Button size="sm" className="btn-icon btn-icon-only" color="danger">
                                  <i className="fa fa-config btn-icon-wrapper"> {" "} </i>
                                </Button>
                              </div>
                            </div>
                          </div>
